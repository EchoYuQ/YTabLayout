...
import com.youdao.xtablayoutlibrary.R;
...
public class YDTabLayout extends HorizontalScrollView {
    ...
    public interface OnTabSelectedListener {
         ...
         */
        public void onTabSelected(YDTabLayout.Tab tab);
         ...
         */
        public void onTabUnselected(YDTabLayout.Tab tab);
         ...
         */
        public void onTabReselected(YDTabLayout.Tab tab);
    }

    private final ArrayList<Tab> mTabs = new ArrayList<>();
    private YDTabLayout.Tab mSelectedTab;

    private final YDTabLayout.SlidingTabStrip mTabStrip;
    ...
    private Drawable xTabBackground = null;
    ...
    private YDTabLayout.TabLayoutOnPageChangeListener mPageChangeListener;

    // Pool we use as a simple RecyclerBin
    private final Pools.Pool<TabView> mTabViewPool = new Pools.SimplePool<>(12);

    public YDTabLayout(Context context) {
        this(context, null);
    }

    public YDTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YDTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        mTabStrip = new YDTabLayout.SlidingTabStrip(context);
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.YDTabLayout,
                defStyleAttr, android.support.design.R.style.Widget_Design_TabLayout);

        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabIndicatorHeight, dpToPx(2)));
        mTabStrip.setmSelectedIndicatorWidth(
                a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabIndicatorWidth, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.YDTabLayout_xTabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.YDTabLayout_xTabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabPaddingBottom,
                mTabPaddingBottom);

        mTabMarginStart = mTabMarginTop = mTabMarginEnd = mTabMarginBottom = a
                .getDimensionPixelSize(R.styleable.YDTabLayout_xTabMargin, 0);
        mTabMarginStart = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabMarginStart,
                mTabMarginStart);
        mTabMarginTop = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabMarginTop,
                mTabMarginTop);
        mTabMarginEnd = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabMarginEnd,
                mTabMarginEnd);
        mTabMarginBottom = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabMarginBottom,
                mTabMarginBottom);


        xTabTextAllCaps = a.getBoolean(R.styleable.YDTabLayout_xTabTextAllCaps, false);

        mTabTextAppearance = a.getResourceId(R.styleable.YDTabLayout_xTabTextAppearance,
                android.support.design.R.style.TextAppearance_Design_Tab);
        mTabTextSize = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabTextSize, 0);
        xTabTextBold = a.getBoolean(R.styleable.YDTabLayout_xTabTextBold, false);
        mTabSelectedTextSize = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabSelectedTextSize, 0);
        xTabTextSelectedBold = a.getBoolean(R.styleable.YDTabLayout_xTabTextSelectedBold, false);
        ...
        if (a.hasValue(R.styleable.YDTabLayout_xTabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.YDTabLayout_xTabTextColor);
        }

        if (a.hasValue(R.styleable.YDTabLayout_xTabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.YDTabLayout_xTabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        xTabDisplayNum = a.getInt(R.styleable.YDTabLayout_xTabDisplayNum, 0);
        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabMaxWidth,
                INVALID_WIDTH);
        xTabBackgroundColor = a.getColor(R.styleable.YDTabLayout_xTabBackgroundColor, 0);
        xTabBackground = a.getDrawable(R.styleable.YDTabLayout_xTabBackground);

        xTabSelectedBackgroundColor = a.getColor(R.styleable.YDTabLayout_xTabSelectedBackgroundColor, 0);
        xTabSelectedBackground = a.getDrawable(R.styleable.YDTabLayout_xTabSelectedBackground);

        mContentInsetStart = a.getDimensionPixelSize(R.styleable.YDTabLayout_xTabContentStart, 0);
...
//        invalidate();
     ...
     */
    public void addTab(@NonNull YDTabLayout.Tab tab) {
     ...
     */
    public void addTab(@NonNull YDTabLayout.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull YDTabLayout.Tab tab, boolean setSelected) {
        if (tab.mParent != this) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull YDTabLayout.Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to a different TabLayout.");
        }
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        final YDTabLayout.Tab tab = newTab();
        if (item.mText != null) {
     ...
     */
    public void setOnTabSelectedListener(YDTabLayout.OnTabSelectedListener onTabSelectedListener) {
        mOnTabSelectedListener = onTabSelectedListener;
    }

    @NonNull
    public YDTabLayout.Tab newTab() {
        YDTabLayout.Tab tab = sTabPool.acquire();
        if (tab == null) {
            tab = new YDTabLayout.Tab();
        }
        tab.mParent = this;
     ...
     */
    @Nullable
    public YDTabLayout.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(YDTabLayout.Tab tab) {
        if (tab.mParent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final YDTabLayout.Tab removedTab = mTabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<Tab> i = mTabs.iterator(); i.hasNext(); ) {
            final YDTabLayout.Tab tab = i.next();
            i.remove();
            tab.reset();
    ...
    public void setupWithViewPager(@Nullable final ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new YDTabLayout.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            setOnTabSelectedListener(new YDTabLayout.ViewPagerOnTabSelectedListener(viewPager));
    ...
    private void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new YDTabLayout.PagerAdapterObserver();
            }
    ...
    private YDTabLayout.TabView createTabView(@NonNull final YDTabLayout.Tab tab) {
        YDTabLayout.TabView tabView = mTabViewPool != null ? mTabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new YDTabLayout.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(YDTabLayout.Tab tab, int position) {
    ...
    private void addTabView(YDTabLayout.Tab tab, boolean setSelected) {
        final YDTabLayout.TabView tabView = tab.mView;
    ...
    private void addTabView(YDTabLayout.Tab tab, int position, boolean setSelected) {
        final YDTabLayout.TabView tabView = tab.mView;
    ...
    private LinearLayout.LayoutParams createLayoutParamsForTabs() {
        ...
        lp.setMargins(mTabMarginStart, mTabMarginTop, mTabMarginEnd, mTabMarginBottom);
        return lp;
    }
    ...
    private void removeTabViewAt(int position) {
        final YDTabLayout.TabView view = (YDTabLayout.TabView) mTabStrip.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == YDTabLayout.Tab.INVALID_POSITION) {
            return;
        }
    ...
    void selectTab(YDTabLayout.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(YDTabLayout.Tab tab, boolean updateIndicator) {
        if (mSelectedTab == tab) {
            ...
            if (updateIndicator) {
                final int newPosition = tab != null ? tab.getPosition() : YDTabLayout.Tab.INVALID_POSITION;
                if (newPosition != YDTabLayout.Tab.INVALID_POSITION) {
                    setSelectedTabView(newPosition);
                }
                if ((mSelectedTab == null || mSelectedTab.getPosition() == YDTabLayout.Tab.INVALID_POSITION)
                        && newPosition != YDTabLayout.Tab.INVALID_POSITION) {
    ...
    public static final class Tab {
        ...
        private YDTabLayout mParent;
        private YDTabLayout.TabView mView;
         ...
         */
        @NonNull
        public YDTabLayout.Tab setTag(@Nullable Object tag) {
            mTag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public YDTabLayout.Tab setCustomView(@Nullable View view) {
            mCustomView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public YDTabLayout.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public YDTabLayout.Tab setIcon(@Nullable Drawable icon) {
            mIcon = icon;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public YDTabLayout.Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
         ...
         */
        @NonNull
        public YDTabLayout.Tab setText(@Nullable CharSequence text) {
            mText = text;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public YDTabLayout.Tab setText(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public YDTabLayout.Tab setContentDescription(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public YDTabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        ...
        private void setTab(@Nullable final YDTabLayout.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
        ...
        final void update() {
            final YDTabLayout.Tab tab = mTab;
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            YDTabLayout.Tab tab = mTabs.get(i);
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<YDTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(YDTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final YDTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
     ...
     */
    public static class ViewPagerOnTabSelectedListener implements YDTabLayout.OnTabSelectedListener {
