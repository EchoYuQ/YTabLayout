...
public class XTabLayout extends HorizontalScrollView {
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        mTabMarginStart = mTabMarginTop = mTabMarginEnd = mTabMarginBottom = a
                .getDimensionPixelSize(R.styleable.XTabLayout_xTabMargin, 0);
        mTabMarginStart = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabMarginStart,
                mTabMarginStart);
        mTabMarginTop = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabMarginTop,
                mTabMarginTop);
        mTabMarginEnd = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabMarginEnd,
                mTabMarginEnd);
        mTabMarginBottom = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabMarginBottom,
                mTabMarginBottom);
        ...
        xTabBackground = a.getDrawable(R.styleable.XTabLayout_xTabBackground);

        xTabSelectedBackgroundColor = a.getColor(R.styleable.XTabLayout_xTabSelectedBackgroundColor, 0);
        xTabSelectedBackground = a.getDrawable(R.styleable.XTabLayout_xTabSelectedBackground);
